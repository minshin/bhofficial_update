...
class Type extends Model
{
    ...
    public $table = 'bohe_doctor_types';
    ...
    public $rules = [
        'name' => 'required',
        'slug' => 'required|between:3,64|unique:bohe_doctor_types',
        'code' => 'unique:bohe_doctor_types',
    ];
    ...
    public $belongsToMany = [
        'posts' => ['Bohe\Article\Models\Index',
